...
// SpecieWidgetDispatch
public class SpecieWidgetDispatch extends Activity
{
    public static final String TAG = "SpecieWidgetDispatch";
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        // Start update
        Intent update = new Intent(this, SpecieWidgetUpdate.class);
        startService(update);
